...
class SampleDevelopmentReport(models.AbstractModel):
    _name = 'report.punjab_dharki_sales_invoice.module_report'

    @api.model
    def render_html(self,docids, data=None):
        report_obj = self.env['report']
        report = report_obj._get_report_from_name('punjab_dharki_sales_invoice.module_report')
        print "------------------------------------------0"
        ...
        return report_obj.render('punjab_dharki_sales_invoice.module_report', docargs)