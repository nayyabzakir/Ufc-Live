...
class SampleDevelopmentReport(models.AbstractModel):
    _name = 'report.omer_customer_invoice_advance.module_report'

    @api.model
    def render_html(self,docids, data=None):
        report_obj = self.env['report']
        report = report_obj._get_report_from_name('omer_customer_invoice_advance.module_report')
        ...
        return report_obj.render('omer_customer_invoice_advance.module_report', docargs)